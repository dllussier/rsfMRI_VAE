...
GAMMA = 0.9 
HDIM=576
IMG=3       #set to 1 for grayscale and 3 for rgb
...
class VAE(nn.Module):
    def __init__(self, image_channels=IMG, h_dim=HDIM, z_dim=ZDIMS, n_classes=CLASSES):
        ...
        print("VAE")
        #encoder layers
        self.conv1 = nn.Conv2d(image_channels, 16, kernel_size=2)
        self.conv2 = nn.Conv2d(16, 32, kernel_size=2)
        self.conv3 = nn.Conv2d(32, 96, kernel_size=2)
        self.conv4 = nn.Conv2d(96, 96, kernel_size=2)
        ...
        self.conv_tran4 = nn.ConvTranspose2d(h_dim, 96, kernel_size=(2,3))
        self.conv_tran3 = nn.ConvTranspose2d(96, 96, kernel_size=2)
        self.conv_tran2 = nn.ConvTranspose2d(96, 32, kernel_size=(3,2))
        self.conv_tran1 = nn.ConvTranspose2d(32, 16, kernel_size=(3,2))
        self.conv_tran0 = nn.ConvTranspose2d(16, image_channels, kernel_size=(2,3))
