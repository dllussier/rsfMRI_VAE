...
2D convolutional varational autoencoder wuthg maxpooling/unpooling.
Works with 3D nifti images of resting state netorks, generated by NIAK 
using the MIST functional atlas, in labeled folders. 
"""
